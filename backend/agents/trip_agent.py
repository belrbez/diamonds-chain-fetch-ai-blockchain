...
class TripAgent(OEFAgent):
    def __init__(self, data, *args, **kwargs):
        ...
        self.data = {
            ...
            "from_location_longitude": data['from_location'].longitude,
            "to_location_latitude": data['to_location'].latitude,
            "to_location_longitude": data['to_location'].longitude,
...
def add_trip_agent(data):
    ...
    print('Add agent Trip: ', data['name'], str(agent.trip_description.values.get('from_location').longitude))
