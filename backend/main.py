...
def add_journey_request():
    ...
    data['status'] = 'WAIT'
    data['from_location'] = {'latitude': data['start']['latitude'], 'longitude': data['start']['longitude']}
    data['to_location'] = {'latitude': data['end']['latitude'], 'longitude': data['end']['longitude']}
