...
def add_journey_request():
    ...
    data['status'] = 'WAIT'
    data['from_location'] = {'latitude': data['start']['longitude'], 'longitude': data['start']['latitude']}
    data['to_location'] = {'latitude': data['end']['longitude'], 'longitude': data['end']['latitude']}
